	...
	<div class="agileits-con">
		<div class="contact-w3-agileits">
			<div class="container">
				...
				<h2 class="w3ls_head">Add Jobtypes</h2>
					
						<form align="center"  method="POST" action="addjobtypes.php" enctype="multipart/form-data">
					<fieldset>
						...
						<center><table border=2	style="text-align:center;">
							...
							<tr>
								<td colspan=2 > <input	align="center" type="submit" name="submit" value="Add Jobtype"> </td>
							</tr>	
							</table></fieldset>
							</form></center>
